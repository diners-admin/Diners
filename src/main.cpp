...
const string strMessageMagic = "Diners Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Diners", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1543105867, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Gracias por usar Diners desde el 25 de Noviembre de 2018";
        CTransaction txNew;
        txNew.nTime = 1543105867;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1543105867;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 3169146 : 3169146;
        ...
        assert(block.hashMerkleRoot == uint256("0x54bd203e48f71b1c5eb274408ee4d0bebe768c4ca6935d2d3b5183c58b827e3f"));
...
unsigned char pchMessageStart[4] = { 0xc6, 0x00, 0x21, 0xe2 };
